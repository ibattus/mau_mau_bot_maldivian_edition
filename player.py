...
#            is_playable = False
                ...
                (card.special == c.CHOOSE):
            self.logger.debug("Can't play colorchooser if draw 4 played")
            is_playable = False
#        elif (last.special == c.DRAW_FOUR) and \
#                (last.color == card.color or last.color != card.color):
#            self.logger.debug("Can't play normal cards if draw 4 played")
#            is_playable = False
